  ...
  return (
    ...
    >
      ...
      <div className="md:flex flex-row md:relative">
        <Image
          className="rounded-full object-cover w-[9rem] h-[9rem] mb-[1.4rem] block mx-auto md:ml-[1.2rem]"
          src="/DP.jpg"
          width={200}
          height={200}
          quality={100}
        ...
        <div className="relative rounded-3xl bg-[#302F4E] mx-[1rem] -mt-[2.8rem] md:mt-[0.1rem] md:ml-[2.3rem] md:mr-[1.5rem]">
          <p className="text-white text-[0.9rem] lg:text-[1.25rem] font-light lg:font-normal px-[1.6rem] pt-[2rem] text-center z-10 md:text-left">
            I am a dynamic and motivated Frontend Developer passionate about
            crafting visually appealing and intuitive web applications.
            Committed to continuous learning and growth, I thrive in
            collaborative environments and excel in delivering results. I am
            seeking an opportunity to apply my skills and contribute to
            innovative projects as part of a progressive organization. Open to
            exciting career prospects and ready to make a positive impact in the
            programming field.
          </p>
