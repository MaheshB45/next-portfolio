...
import ContactButton from "@/components/Shared/ContactBtn";
  ...
  return (
    <section id="home">
      ...
      <div className="flex flex-col items-center justify-center h-screen">
        {/* Image */}
        <Image className="rounded-full object-cover w-[7.188rem] h-[7.188rem] lg:w-[8.2rem] lg:h-[8.2rem] mb-[1.4rem]"
          src="/DP.jpg"
          width={200}
          height={200}
          quality={100}
      ...
      <p className="text-center text-white text-[0.9rem] -mt-[2.5rem] mb-[0.6rem]">
        Scroll Down
      </p>
